...
public class MessageReceiverTest {
  ...
  public void testCommandPass() throws Exception {
    ...
    msg.commandMap = new HashMap<ProtocolMessage, CommandAction> ();
    ...
    msg.receive(new org.jgroups.Message(null, null, "{\"command\":\""+ProtocolMessage.UPDATE_DONE.name()+"\"}"));
  ...
  public void testCommandFail() throws Exception {
    ...
    try {
      msg.receive(new org.jgroups.Message(null, null, "{\"command\":\""+ProtocolMessage.CURRENT_STATE.name()+"\"}"));
