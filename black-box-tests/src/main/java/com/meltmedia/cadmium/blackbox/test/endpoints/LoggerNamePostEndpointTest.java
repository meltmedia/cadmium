...
/**
 * Tests the system logger post for a specific logger endpoint.
 *
 * @author John McEntire
 */
public class LoggerNamePostEndpointTest extends AbstractEnpointTest {

  public LoggerNamePostEndpointTest(String token) {
    super(token);
  }

  @Override
  public void setupTest() {
    request = new ApiRequest("http://localhost:8901/system/logger/com.meltmedia.cadmium/TRACE", ApiRequest.Method.POST, authToken);
