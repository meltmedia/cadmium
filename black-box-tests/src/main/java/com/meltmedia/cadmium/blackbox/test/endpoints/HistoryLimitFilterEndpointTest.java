 ...
 */
public class HistoryLimitFilterEndpointTest extends AbstractEnpointTest {
  public HistoryLimitFilterEndpointTest(String token) {
    super(token);
  }

  @Override
  public void setupTest() {
    request = new ApiRequest("http://localhost:8901/system/history?limit=1&filter=true", ApiRequest.Method.GET, authToken);
