...
/**
 * Tests the system logger get a specific logger endpoint.
 *
 * @author John McEntire
 */
public class LoggerNameGetEndpointTest extends AbstractEnpointTest {

  public LoggerNameGetEndpointTest(String token) {
    super(token);
  }

  @Override
  public void setupTest() {
    request = new ApiRequest("http://localhost:8901/system/logger/com.meltmedia.cadmium", ApiRequest.Method.GET, authToken);
